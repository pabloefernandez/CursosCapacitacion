Public Class Prerreq
    ...
    Private Sub Prerreq_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If A_Edicion = True Then
            ...
            Procedure()
            RS.Read()
            Sql = "select Curso from cursos where idarea=" & RS(0) & ""
            Procedure()
            While RS.Read
    ...
    Private Sub btnIngresar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnIngresar.Click
        ...
        If A_Edicion = True Then
            ...
            Else
                ...
                cboCursos.Text = ""
                chkObligatorio.Checked = False
                A_Ediciones.txtHorarioI.Text = ""
                A_Ediciones.txtHorarioI2.Text = ""
                A_Ediciones.txtHorarioF.Text = ""
                A_Ediciones.txtHorarioF2.Text = ""
                A_Ediciones.txtDia.Text = ""
                A_Edicion = False
