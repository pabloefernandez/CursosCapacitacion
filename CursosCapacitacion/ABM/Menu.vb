Public Class ABM
    Private Sub btnAAreas_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAAreas.Click
        Dim NArea As String
        NArea = InputBox("Ingrese el nombre del area a cargar: ")
        Sql = "select max(idarea)+1 from areas"
        Procedure()
        RS.Read()
        Sql = "insert into areas values(" & RS(0) & ", '" & NArea & "')"
        Procedure()
        MsgBox("El area ha sido ingresada correctamente. Usted sera devuelto al menu principal.")
        Menu1.Show()
        Me.Hide()
    End Sub
    ...
    Private Sub ABM_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
